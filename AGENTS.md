...
- **Testing**: Rust unit tests (239) + integration tests with a mock TCP server that simulates GivEnergy dongle behaviour (no frontend tests)
...
| `cargo test` (in `src-tauri/`) | Run all Rust unit tests (239 tests) |
